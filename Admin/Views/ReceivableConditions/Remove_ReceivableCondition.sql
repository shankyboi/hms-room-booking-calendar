			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_ReceivableCondition"
			  (
				  pvar_ReceivableConditionsid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'ReceivableConditions', 'delete') THEN
			  
            INSERT INTO history
VALUES('ReceivableConditions', NOW(),
(SELECT query_to_xml('SELECT * FROM ReceivableConditions WHERE CAST(ReceivableConditions.ReceivableConditionsid AS VARCHAR)= '''||pvar_ReceivableConditionsid||'''', true, false, '')));
			 ...
			 UPDATE ReceivableConditions SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,NOW()
																,'Critical'
																,'Remove_ReceivableCondition'
																,'Authorization Failed Remove_ReceivableCondition'
																,pvar_modifieduser
																);
