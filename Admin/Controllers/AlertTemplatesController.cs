              ...
              else if (strReturnMessage.StartsWith("BadRequest", StringComparison.OrdinalIgnoreCase))
			{
			  ...
			  public virtual async Task<IActionResult> Update_Alert_Templates(string AlertTemplatesid)
			  {
                    ...
                    if(HttpContext.Session.GetString("NalamVazharole_JSON") != null){
                            ...
                            try{
                                     var jsonObjAlertTemplates = await ApiClient.Get_ApiValues(getHttpClient(), "api/AlertTemplates/getById_AlertTemplates?AlertTemplatesid="+AlertTemplatesid+"&loginUserID="+HttpContext.Session.GetString("NalamVazhaloginUserID"));
...
public virtual async Task<IActionResult> Remove_Alert_Templates(string AlertTemplatesid)
			{
				...
				try
				{
						message = await ApiClient.Get_ApiValues(getHttpClient(), "api/AlertTemplates/Remove_Alert_Templates?AlertTemplatesid="+AlertTemplatesid+"&loginUserID="+HttpContext.Session.GetString("NalamVazhaloginUserID"));
			...
			[HttpGet()]
			public virtual async Task<string> get_Alert_Templates_List(string tenantid, string entityname
,string entityaction
,string alerttype
)
			{
            return await ApiClient.Get_ApiValues(getHttpClient(), "api/AlertTemplates/Alert_Templates_List?tenantid=" + tenantid + "&entityname=" + entityname + "&entityaction=" + entityaction + "&alerttype=" + alerttype + "&loginUserID=" + HttpContext.Session.GetString("NalamVazhaloginUserID")
    );
			}
