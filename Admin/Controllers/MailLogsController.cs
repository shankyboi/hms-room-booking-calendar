              ...
              else if (strReturnMessage.StartsWith("BadRequest", StringComparison.OrdinalIgnoreCase))
			{
			  ...
			  public virtual async Task<IActionResult> Update_MailLog(string MailLogsid)
			  {
                    ...
                    if(HttpContext.Session.GetString("NalamVazharole_JSON") != null){
                            ...
                            try{
                                     var jsonObjMailLogs = await ApiClient.Get_ApiValues(getHttpClient(), "api/MailLogs/getById_MailLogs?MailLogsid="+MailLogsid+"&loginUserID="+HttpContext.Session.GetString("NalamVazhaloginUserID"));
...
public virtual async Task<IActionResult> Remove_MailLog(string MailLogsid)
			{
				...
				try
				{
						message = await ApiClient.Get_ApiValues(getHttpClient(), "api/MailLogs/Remove_MailLog?MailLogsid="+MailLogsid+"&loginUserID="+HttpContext.Session.GetString("NalamVazhaloginUserID"));
				...
				return RedirectToAction(redirectTo);
                                        ...
                                        public virtual IActionResult Detail_MailLog()
                                        {
                                            return View();
                                        }
...
, int? pagesize=100 , int? pagenumber=0,string searchterm="",string sortFieldsJson="")
			        {
				        ...
				        return await ApiClient.Get_ApiValues(getHttpClient(), "api/MailLogs/MailLogs_List?entityname="+entityname+"&mailfor="+mailfor+"&loginUserID="+HttpContext.Session.GetString("NalamVazhaloginUserID")
