...
[xssFilter]
			...
			public class CountryModelValidator: AbstractValidator<CountryModel>
			{
					...
					public CountryModelValidator()
					{
						 ...
						 When(model => model.craftmyapp_actionmethodname == "Add_Country", () =>
                                    {
                                        {RuleFor(m => m.countryname)
.NotEmpty().WithMessage("Country Name is required")
.MaximumLength(128).WithMessage("The allowed length of Country Name is 128 characters or fewer")
;
...
When(model => model.craftmyapp_actionmethodname == "Update_Country", () =>
                                    {
                                        {RuleFor(m => m.countryname)
.NotEmpty().WithMessage("Country Name is required")
.MaximumLength(128).WithMessage("The allowed length of Country Name is 128 characters or fewer")
