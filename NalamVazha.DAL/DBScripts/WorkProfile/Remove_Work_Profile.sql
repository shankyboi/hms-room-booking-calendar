			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Work_Profile"
			  (
				  pvar_WorkProfileid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'WorkProfile', 'delete') THEN
			  
            INSERT INTO history
VALUES('WorkProfile', NOW(),
(SELECT query_to_xml('SELECT * FROM WorkProfile WHERE CAST(WorkProfile.WorkProfileid AS VARCHAR)= '''||pvar_WorkProfileid||'''', true, false, '')));
			 ...
			 UPDATE WorkProfile SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Work_Profile'
																,'Authorization Failed Remove_Work_Profile'
																,pvar_modifieduser
																);
