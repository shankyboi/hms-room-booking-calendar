								        ...
								        CREATE OR REPLACE FUNCTION  "lookup_EnquiryForm_medicalinfo_medicalcondition"
								        (
...
,conditionname Varchar
	...
	then
		...
		pvar_searchterm := null;
                                        ...
                                        RETURN QUERY        
								        SELECT  
								        CAST(MedicalCondition.MedicalConditionid AS Varchar) as MedicalConditionid,CAST(MedicalCondition.conditionname AS Varchar) as conditionname,CAST(MedicalCondition.conditionname AS Varchar) as conditionname
