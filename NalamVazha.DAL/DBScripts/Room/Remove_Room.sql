			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Room"
			  (
				  pvar_Roomid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'Room', 'delete') THEN
			  
            INSERT INTO history
VALUES('Room', NOW(),
(SELECT query_to_xml('SELECT * FROM Room WHERE CAST(Room.Roomid AS VARCHAR)= '''||pvar_Roomid||'''', true, false, '')));
			 ...
			 UPDATE Room SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Room'
																,'Authorization Failed Remove_Room'
																,pvar_modifieduser
																);
