			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Staff_Attendance"
			  (
				  pvar_StaffAttendanceid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'StaffAttendance', 'delete') THEN
			  
            INSERT INTO history
VALUES('StaffAttendance', NOW(),
(SELECT query_to_xml('SELECT * FROM StaffAttendance WHERE CAST(StaffAttendance.StaffAttendanceid AS VARCHAR)= '''||pvar_StaffAttendanceid||'''', true, false, '')));
			 ...
			 UPDATE StaffAttendance SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,NOW()
																,'Critical'
																,'Remove_Staff_Attendance'
																,'Authorization Failed Remove_Staff_Attendance'
																,pvar_modifieduser
																);
