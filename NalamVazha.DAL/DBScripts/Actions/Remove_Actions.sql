			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Actions"
			  (
				  pvar_Actionsid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'Actions', 'delete') THEN
			  
            INSERT INTO history
VALUES('Actions', NOW(),
(SELECT query_to_xml('SELECT * FROM Actions WHERE CAST(Actions.Actionsid AS VARCHAR)= '''||pvar_Actionsid||'''', true, false, '')));
			 ...
			 UPDATE Actions SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Actions'
																,'Authorization Failed Remove_Actions'
																,pvar_modifieduser
																);
