			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Enquiry_Type"
			  (
				  pvar_EnquiryTypeid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'EnquiryType', 'delete') THEN
			  
            INSERT INTO history
VALUES('EnquiryType', NOW(),
(SELECT query_to_xml('SELECT * FROM EnquiryType WHERE CAST(EnquiryType.EnquiryTypeid AS VARCHAR)= '''||pvar_EnquiryTypeid||'''', true, false, '')));
			 ...
			 UPDATE EnquiryType SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Enquiry_Type'
																,'Authorization Failed Remove_Enquiry_Type'
																,pvar_modifieduser
																);
