			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Therapy_Category"
			  (
				  pvar_TherapyCategoryid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'TherapyCategory', 'delete') THEN
			  
            INSERT INTO history
VALUES('TherapyCategory', NOW(),
(SELECT query_to_xml('SELECT * FROM TherapyCategory WHERE CAST(TherapyCategory.TherapyCategoryid AS VARCHAR)= '''||pvar_TherapyCategoryid||'''', true, false, '')));
			 ...
			 UPDATE TherapyCategory SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,NOW()
																,'Critical'
																,'Remove_Therapy_Category'
																,'Authorization Failed Remove_Therapy_Category'
																,pvar_modifieduser
																);
