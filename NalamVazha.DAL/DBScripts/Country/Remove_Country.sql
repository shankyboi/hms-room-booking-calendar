			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Country"
			  (
				  pvar_Countryid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'Country', 'delete') THEN
			  
            INSERT INTO history
VALUES('Country', NOW(),
(SELECT query_to_xml('SELECT * FROM Country WHERE CAST(Country.Countryid AS VARCHAR)= '''||pvar_Countryid||'''', true, false, '')));
			 ...
			 UPDATE Country SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Country'
																,'Authorization Failed Remove_Country'
																,pvar_modifieduser
																);
