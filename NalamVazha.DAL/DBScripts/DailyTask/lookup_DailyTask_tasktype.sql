								...
								CREATE OR REPLACE FUNCTION  "lookup_DailyTask_tasktype"
								(
...
,tasktype Varchar
 ...
 AND  ((pvar_searchterm is null)  or TypeofTask.tasktype::varchar ilike pvar_searchterm or  CAST(TypeofTask.TypeofTaskid AS Varchar) ilike pvar_searchterm)
