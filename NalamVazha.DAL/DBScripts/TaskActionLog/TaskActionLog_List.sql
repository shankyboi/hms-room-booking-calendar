			  ...
			  CREATE OR REPLACE FUNCTION  "TaskActionLog_List"
...
,pvar_sort_fields json
 ...
 OR ((pvar_searchterm is null) or CAST(TaskActionLog.tasktype AS VARCHAR) ilike pvar_searchterm)
 OR ((pvar_searchterm is null) or CAST(TaskActionLog.nextaction AS VARCHAR) ilike pvar_searchterm)
))                   
                    ,'detail'
...
,TaskActionLog.nextaction
 ...
 OR ((pvar_searchterm is null) or CAST(TaskActionLog.nextaction AS VARCHAR) ilike pvar_searchterm)
                    ...
                    CASE local_sortcolumn_array[1]
                      WHEN 'tasktype' THEN TaskActionLog.tasktype::TEXT
WHEN 'nextaction' THEN TaskActionLog.nextaction::TEXT
