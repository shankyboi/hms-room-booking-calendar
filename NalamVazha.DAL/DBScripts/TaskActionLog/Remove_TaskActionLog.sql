			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_TaskActionLog"
			  (
				  pvar_TaskActionLogid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'TaskActionLog', 'delete') THEN
			  
            INSERT INTO history
VALUES('TaskActionLog', NOW(),
(SELECT query_to_xml('SELECT * FROM TaskActionLog WHERE CAST(TaskActionLog.TaskActionLogid AS VARCHAR)= '''||pvar_TaskActionLogid||'''', true, false, '')));
			 ...
			 UPDATE TaskActionLog SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,NOW()
																,'Critical'
																,'Remove_TaskActionLog'
																,'Authorization Failed Remove_TaskActionLog'
																,pvar_modifieduser
																);
