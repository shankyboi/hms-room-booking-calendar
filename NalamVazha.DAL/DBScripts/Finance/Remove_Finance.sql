			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Finance"
			  (
				  pvar_Financeid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'Finance', 'delete') THEN
			  
            INSERT INTO history
VALUES('Finance', NOW(),
(SELECT query_to_xml('SELECT * FROM Finance WHERE CAST(Finance.Financeid AS VARCHAR)= '''||pvar_Financeid||'''', true, false, '')));
			 ...
			 UPDATE Finance SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Finance'
																,'Authorization Failed Remove_Finance'
																,pvar_modifieduser
																);
