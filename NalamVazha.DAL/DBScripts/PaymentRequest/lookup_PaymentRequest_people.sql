								...
								CREATE OR REPLACE FUNCTION  "lookup_PaymentRequest_people"
								(
...
,contactnumber Varchar
	...
	then
		...
		pvar_searchterm := null;
                                ...
                                RETURN QUERY        
								SELECT  
								CAST(People.Peopleid AS Varchar) as Peopleid,CAST(People.firstname AS Varchar) as firstname,CAST(People.lastname AS Varchar) as lastname,CAST(People.contactnumber AS Varchar) as contactnumber
								FROM People
 ...
 AND  ((pvar_searchterm is null)  or People.firstname::varchar ilike pvar_searchterm or People.lastname::varchar ilike pvar_searchterm or People.contactnumber::varchar ilike pvar_searchterm or  CAST(People.Peopleid AS Varchar) ilike pvar_searchterm)
 ORDER BY People.contactnumber ASC
                                 limit pvar_pagesize
