			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Action_Type"
			  (
				  pvar_ActionTypeid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'ActionType', 'delete') THEN
			  
            INSERT INTO history
VALUES('ActionType', NOW(),
(SELECT query_to_xml('SELECT * FROM ActionType WHERE CAST(ActionType.ActionTypeid AS VARCHAR)= '''||pvar_ActionTypeid||'''', true, false, '')));
			 ...
			 UPDATE ActionType SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Action_Type'
																,'Authorization Failed Remove_Action_Type'
																,pvar_modifieduser
																);
