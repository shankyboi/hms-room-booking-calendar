			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'Block', 'delete') THEN
			  
            INSERT INTO history
VALUES('Block', NOW(),
(SELECT query_to_xml('SELECT * FROM Block WHERE CAST(Block.Blockid AS VARCHAR)= '''||pvar_Blockid||'''', true, false, '')));
			 ...
			 UPDATE Block SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Block'
																,'Authorization Failed Remove_Block'
																,pvar_modifieduser
																);
