			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Appoinment"
			  (
				  pvar_Appoinmentid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'Appoinment', 'delete') THEN
			  
            INSERT INTO history
VALUES('Appoinment', NOW(),
(SELECT query_to_xml('SELECT * FROM Appoinment WHERE CAST(Appoinment.Appoinmentid AS VARCHAR)= '''||pvar_Appoinmentid||'''', true, false, '')));
			 ...
			 UPDATE Appoinment SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Appoinment'
																,'Authorization Failed Remove_Appoinment'
																,pvar_modifieduser
																);
