								        ...
								        CREATE OR REPLACE FUNCTION  "lookup_ClinicalTask_taskduration_taskname"
								        (
...
AND LOWER(COALESCE(TRIM(Task.taskname), '')) <> 'default template'
