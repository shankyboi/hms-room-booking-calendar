DROP FUNCTION IF EXISTS public."lookup_ShiftPlanning_shiftname"(character varying, character varying, integer, integer);

CREATE OR REPLACE FUNCTION public."lookup_ShiftPlanning_shiftname"(
    ...
    RETURNS TABLE("Shiftid" character varying, shiftname character varying,shiftstarttime Varchar,shiftendtime Varchar) 
    LANGUAGE 'plpgsql'
    COST 100
