			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Therapy_Item_Category"
			  (
				  pvar_TherapyItemCategoryid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'TherapyItemCategory', 'delete') THEN
			  
            INSERT INTO history
VALUES('TherapyItemCategory', NOW(),
(SELECT query_to_xml('SELECT * FROM TherapyItemCategory WHERE CAST(TherapyItemCategory.TherapyItemCategoryid AS VARCHAR)= '''||pvar_TherapyItemCategoryid||'''', true, false, '')));
			 ...
			 UPDATE TherapyItemCategory SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,NOW()
																,'Critical'
																,'Remove_Therapy_Item_Category'
																,'Authorization Failed Remove_Therapy_Item_Category'
																,pvar_modifieduser
																);
