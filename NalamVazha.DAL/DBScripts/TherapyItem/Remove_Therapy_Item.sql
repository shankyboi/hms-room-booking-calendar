			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Therapy_Item"
			  (
				  pvar_TherapyItemid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'TherapyItem', 'delete') THEN
			  
            INSERT INTO history
VALUES('TherapyItem', NOW(),
(SELECT query_to_xml('SELECT * FROM TherapyItem WHERE CAST(TherapyItem.TherapyItemid AS VARCHAR)= '''||pvar_TherapyItemid||'''', true, false, '')));
			 ...
			 UPDATE TherapyItem SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Therapy_Item'
																,'Authorization Failed Remove_Therapy_Item'
																,pvar_modifieduser
																);
