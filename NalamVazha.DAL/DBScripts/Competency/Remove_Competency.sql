			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Competency"
			  (
				  pvar_Competencyid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'Competency', 'delete') THEN
			  
            INSERT INTO history
VALUES('Competency', NOW(),
(SELECT query_to_xml('SELECT * FROM Competency WHERE CAST(Competency.Competencyid AS VARCHAR)= '''||pvar_Competencyid||'''', true, false, '')));
			 ...
			 UPDATE Competency SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Competency'
																,'Authorization Failed Remove_Competency'
																,pvar_modifieduser
																);
