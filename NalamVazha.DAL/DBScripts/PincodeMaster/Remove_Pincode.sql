			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Pincode"
			  (
				  pvar_PincodeMasterid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'PincodeMaster', 'delete') THEN
			  
            INSERT INTO history
VALUES('PincodeMaster', NOW(),
(SELECT query_to_xml('SELECT * FROM PincodeMaster WHERE CAST(PincodeMaster.PincodeMasterid AS VARCHAR)= '''||pvar_PincodeMasterid||'''', true, false, '')));
			 ...
			 UPDATE PincodeMaster SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Pincode'
																,'Authorization Failed Remove_Pincode'
																,pvar_modifieduser
																);
