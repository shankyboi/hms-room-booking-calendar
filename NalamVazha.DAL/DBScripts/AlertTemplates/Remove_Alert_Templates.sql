            ...
            INSERT INTO history
VALUES('AlertTemplates', NOW(),
(SELECT query_to_xml('SELECT * FROM AlertTemplates WHERE CAST(AlertTemplates.AlertTemplatesid AS VARCHAR)= '''||pvar_AlertTemplatesid||'''', true, false, '')));
