			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Occupation"
			  (
				  pvar_Occupationid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'Occupation', 'delete') THEN
			  
            INSERT INTO history
VALUES('Occupation', NOW(),
(SELECT query_to_xml('SELECT * FROM Occupation WHERE CAST(Occupation.Occupationid AS VARCHAR)= '''||pvar_Occupationid||'''', true, false, '')));
			 ...
			 UPDATE Occupation SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Occupation'
																,'Authorization Failed Remove_Occupation'
																,pvar_modifieduser
																);
