...
CREATE OR REPLACE FUNCTION public."lookup_PeopleTimePreference_people"(
	pvar_tenantid character varying DEFAULT NULL::character varying,
	pvar_workprofile character varying DEFAULT NULL::character varying,
    ...
    RETURNS TABLE("Peopleid" character varying, firstname character varying, lastname character varying) 
    LANGUAGE 'plpgsql'
    COST 100
