			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Medicine"
			  (
				  pvar_Medicineid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'Medicine', 'delete') THEN
			  
            INSERT INTO history
VALUES('Medicine', NOW(),
(SELECT query_to_xml('SELECT * FROM Medicine WHERE CAST(Medicine.Medicineid AS VARCHAR)= '''||pvar_Medicineid||'''', true, false, '')));
			 ...
			 UPDATE Medicine SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Medicine'
																,'Authorization Failed Remove_Medicine'
																,pvar_modifieduser
																);
