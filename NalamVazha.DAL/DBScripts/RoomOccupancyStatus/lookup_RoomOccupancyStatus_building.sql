								...
								CREATE OR REPLACE FUNCTION  "lookup_RoomOccupancyStatus_building"
								(
...
,buildingname Varchar
                ...
                lvar_tenantid := lvar_tenantid || ARRAY[''::character varying] || ARRAY['00000000-0000-0000-0000-000000000000'::character varying];
                                ...
                                RETURN QUERY        
								SELECT  
								CAST(Building.Buildingid AS Varchar) as Buildingid,CAST(Building.buildingname AS Varchar) as buildingname
								FROM Building
