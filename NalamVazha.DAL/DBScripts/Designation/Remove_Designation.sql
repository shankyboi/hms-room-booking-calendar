			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Designation"
			  (
				  pvar_Designationid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'Designation', 'delete') THEN
			  
            INSERT INTO history
VALUES('Designation', NOW(),
(SELECT query_to_xml('SELECT * FROM Designation WHERE CAST(Designation.Designationid AS VARCHAR)= '''||pvar_Designationid||'''', true, false, '')));
			 ...
			 UPDATE Designation SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Designation'
																,'Authorization Failed Remove_Designation'
																,pvar_modifieduser
																);
