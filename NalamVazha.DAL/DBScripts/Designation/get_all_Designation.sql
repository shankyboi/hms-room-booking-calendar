			  ...
			  CREATE OR REPLACE FUNCTION  "get_all_Designation"
              (
...
,Designation.designation
			  ...
			  FROM Designation
			  WHERE
               (lvar_tenantid is null or COALESCE(cast(Designation.tenantid as varchar),'') = Any(lvar_tenantid))
                 
			   AND Designation.isdeleted=false
			  ;
