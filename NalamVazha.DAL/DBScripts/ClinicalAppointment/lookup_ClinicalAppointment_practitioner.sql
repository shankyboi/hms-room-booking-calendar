								...
								CREATE OR REPLACE FUNCTION  "lookup_ClinicalAppointment_practitioner"
								(
...
,photo Varchar
	...
	then
		...
		pvar_searchterm := null;
                                ...
                                RETURN QUERY        
								SELECT  
								CAST(People.Peopleid AS Varchar) as Peopleid,CAST(People.firstname AS Varchar) as firstname,CAST(People.lastname AS Varchar) as lastname,CAST(People.photo AS Varchar) as photo
								FROM People
