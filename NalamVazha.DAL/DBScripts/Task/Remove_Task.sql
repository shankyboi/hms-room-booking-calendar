			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Task"
			  (
				  pvar_Taskid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'Task', 'delete') THEN
			  
            INSERT INTO history
VALUES('Task', NOW(),
(SELECT query_to_xml('SELECT * FROM Task WHERE CAST(Task.Taskid AS VARCHAR)= '''||pvar_Taskid||'''', true, false, '')));
			 ...
			 UPDATE Task SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Task'
																,'Authorization Failed Remove_Task'
																,pvar_modifieduser
																);
