			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Floor"
			  (
				  pvar_Floorid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'Floor', 'delete') THEN
			  
            INSERT INTO history
VALUES('Floor', NOW(),
(SELECT query_to_xml('SELECT * FROM Floor WHERE CAST(Floor.Floorid AS VARCHAR)= '''||pvar_Floorid||'''', true, false, '')));
			 ...
			 UPDATE Floor SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Floor'
																,'Authorization Failed Remove_Floor'
																,pvar_modifieduser
																);
