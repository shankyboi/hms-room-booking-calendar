			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Building"
			  (
				  pvar_Buildingid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'Building', 'delete') THEN
			  
            INSERT INTO history
VALUES('Building', NOW(),
(SELECT query_to_xml('SELECT * FROM Building WHERE CAST(Building.Buildingid AS VARCHAR)= '''||pvar_Buildingid||'''', true, false, '')));
			 ...
			 UPDATE Building SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Building'
																,'Authorization Failed Remove_Building'
																,pvar_modifieduser
																);
