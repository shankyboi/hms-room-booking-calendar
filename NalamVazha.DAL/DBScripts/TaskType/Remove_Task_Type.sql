			  ...
			  CREATE OR REPLACE FUNCTION  "Remove_Task_Type"
			  (
				  pvar_TaskTypeid Varchar(50)
			  ...
			  IF "Check_Authorization"(pvar_modifieduser::uuid, 'TaskType', 'delete') THEN
			  
            INSERT INTO history
VALUES('TaskType', NOW(),
(SELECT query_to_xml('SELECT * FROM TaskType WHERE CAST(TaskType.TaskTypeid AS VARCHAR)= '''||pvar_TaskTypeid||'''', true, false, '')));
			 ...
			 UPDATE TaskType SET
				  ...
				  pvar_returnMessage := '201.1';
																...
																,'Critical'
																,'Remove_Task_Type'
																,'Authorization Failed Remove_Task_Type'
																,pvar_modifieduser
																);
