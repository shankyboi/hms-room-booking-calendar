			  ...
			  CREATE OR REPLACE FUNCTION  "get_all_TaskType"
              (
...
,TaskType.description
			  ...
			  FROM TaskType
			  WHERE
               (lvar_tenantid is null or COALESCE(cast(TaskType.tenantid as varchar),'') = Any(lvar_tenantid))
                 
			   AND TaskType.isdeleted=false
			  ;
