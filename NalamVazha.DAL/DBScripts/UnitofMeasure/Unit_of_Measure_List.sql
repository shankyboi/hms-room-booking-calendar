			  ...
			  CREATE OR REPLACE FUNCTION  "Unit_of_Measure_List"
              ()
			  RETURNS TABLE(UnitofMeasureid uuid
,unitofmeasurename Varchar,unitofmeasuredesc Varchar,createduser uuid
...
,UnitofMeasure.unitofmeasuredesc
				...
				WHERE UnitofMeasure.isdeleted=false 
				 ...
				 ORDER BY UnitofMeasure.createddate DESC;
