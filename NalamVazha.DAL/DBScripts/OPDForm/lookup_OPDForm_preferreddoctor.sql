								...
								CREATE OR REPLACE FUNCTION  "lookup_OPDForm_preferreddoctor"
								(
...
,lastname Varchar
	...
	then
		...
		pvar_searchterm := null;
								...
								FROM People
								INNER JOIN WorkProfile
									ON WorkProfile.WorkProfileid = People.workprofile
								 ...
								 AND LOWER(TRIM(COALESCE(WorkProfile.rolename, ''))) = 'doctor'
